...
let mathMethod = {
    ...
    findDifference: function (op1, op2) {
    ...
    // Check if first integer is smaller than second one
    isSmaller: function (op1, op2) {
    ...
    // This function only finds the product of two POSITIVE INTEGERS.
    findProduct(op1, op2) {
      let n1 = op1.length;
      let n2 = op2.length;
      ...
      for (let i = 0; i < n1 + n2; ++i) result[i] = 0;
